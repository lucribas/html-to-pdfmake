...
async function main() {
  ...
  const dataStreams = {
    ...
    stream1: dataStream,
    stream2: fs.createReadStream('./10956871.png'),
    stream3: fs.createReadStream('./IMG_20240108_213702303.jpg'),
  };
...
//   console.log(JSON.stringify(html));
  ...
  pdfDocGenerator.getBuffer(function(buffer) {
    fs.writeFileSync('example_img_stream.pdf', buffer);
    console.log('--> example_img_stream.pdf')
  });
  console.log('--> example_img_stream.pdf')
